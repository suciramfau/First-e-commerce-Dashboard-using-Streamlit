...
#mereplace space dengan underscore
df_sales.columns = df_sales.columns.str.lower().str.replace(' ', '_') 
#merubah data menjadi datetime
df_sales['tanggal_pesanan']=pd.to_datetime(df_sales['tanggal_pesanan'])

# judul dashboard
st.title("Dashboard Analisis Penjualan Toko Online")
st.markdown("Dashboard ini menyediakan gambaran umum *sales performance*, **trend**, dan distribusi berdasarkan berbagai macam dimensi.")
...
if pilihan_halaman == "Overview Dashboard":
    ...
    # Kalau Mau Filter berdasarkan wilayah
    ...
    if pilihan_halaman == "Overview Dashboard":
        ...
        # untuk memastikan urutan bulannya benar
